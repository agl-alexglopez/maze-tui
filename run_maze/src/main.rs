...
fn main() {
    ...
    recursive_backtracker::animate_recursive_backtracker_maze(&mut build_maze_test, maze_util::BuilderSpeed::Speed4);
    print_util::set_cursor_position( maze::Point {row: build_maze_test.row_size(), col: build_maze_test.col_size()});
    println!();
}
